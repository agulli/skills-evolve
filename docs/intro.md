...
The **"What"**. A thin, generated index of the 61 procedural markdown files that guide the agent's behavior — each skill self-documents in its own `SKILL.md` (the single source of truth). These turn tribal knowledge and best practices into executable instructions.
